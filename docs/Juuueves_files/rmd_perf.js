...
(function(){
try {
   var timings = [ { marker: 'knitr', elapsed: 2539 }, { marker: 'pandoc', elapsed: 170 }, { marker: 'post-processor', elapsed: 80 }, { marker: 'pre-processor', elapsed: 20 }, { marker: 'render', elapsed: 3830 } ];
